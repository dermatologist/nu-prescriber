    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientsProprietaries", x => new { x.IngredientId, x.ProprietaryId });
                    table.ForeignKey(
                        name: "FK_IngredientsProprietaries_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "IngredientId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientsProprietaries_Proprietaries_ProprietaryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientsProprietaries_ProprietaryId",
                table: "IngredientsProprietaries",
